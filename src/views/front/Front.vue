        ...
        <div style="display: flex; height: 60px; line-height: 60px; border-bottom: 1px solid #eee">
            <div style="width: 300px; display: flex; padding-left: 30px">
                <div style="width: 60px">
                    <img src="../../assets/frontLogo.gif" alt=""
                         style="border-radius: 40px; width: 40px; position: relative; top: 10px; right: 0">
                </div>
                <div style="flex: 1">欢迎您 {{ user.username }}</div>
            </div>
            <div style="flex: 1">
            ...
            <div>
                <el-button @click="$router.push('/home')" type="primary" icon="el-icon-back" size="medium">跳转后台
                </el-button>
            </div>
